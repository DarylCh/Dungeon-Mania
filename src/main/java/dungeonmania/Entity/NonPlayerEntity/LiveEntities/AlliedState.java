...
public class AlliedState implements LiveEntityState {
    Mercenary mercenary;
    public AlliedState(Mercenary mercenary) {
        this.mercenary = mercenary;
    }

    public void moveNPC(List<NonPlayerEntity> entities) {
        Path shortestPathToPlayer = findShortestPath(entities, mercenary.getPrevPosition());
